...
export default function MagneticSigns() {
  const [product, setProduct] = useState<MagneticSigns[]>([]);
  ...
  useEffect(() => {
    axios.get('http://localhost:4000/magnetic_signs')
